...
| `get_reviews` | Paginated Firefox/Edge user reviews (rating, text, date, language) for an extension — Chrome Web Store reviews excluded; reviewer identity omitted; sort by recent or rating | 1 read |
